...
const API_URL_PRODUCT = 'http://127.0.0.1:3000/product';
...
const App = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {showFormP ? (
        // Mostrando o formulário se o estado showFormP for verdadeiro
        <ProductForm
        ...
        // Mostrando a lista de produtos se o estado showFormP for falso
        <>
           <FlatList
            data={products}
            keyExtractor={(item) => item.id.toString()}
